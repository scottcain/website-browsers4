...
# From the development instance, create a new
# image. This becomes the NEW development image.
# From there, launch a new instance. This will
# become the QAQC instance, and later the production image.
