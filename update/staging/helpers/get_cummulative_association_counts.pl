...
my $version = $ARGV[0];
my $data_directory = "/usr/local/wormbase/databases/$version/ontology/"; ## ontology
...
our $outfile = "$data_directory/id2total_associations.txt";

get_cummulative_associations();
