...
my %classes = (
#	      All_genes
	      Anatomy_name    => { priority => '0.1' },
	      Anatomy_term    => { priority => '0.3' },
	      Antibody        => { priority => '0.3' },
	      Author          => { priority => '0.3' },
#	      briggsae_CDS
#	      Briggsae_genomic
...
#	      Gene_name   => { priority => '0.4' },
	      Gene_regulation => { priority => '0.3' },
#	      Genome_Sequence
#	      GO_code => { priority => '0.1' },
	      GO_term => { priority => '0.3' },
#	      Grid
	      Homology_group => { priority => '0.5' },
#	      Homol_data
#	      Insertion_allele
#	      Journal
#	      KeySet
#	      KO_allele
	      Laboratory => { priority => '0.3' },
	      Life_stage => { priority => '0.3' },
#	      Lineage 
#	      Live_genes
	      Locus => { priority => '0.1' },
#	      Map
...
#	      Oligo_set   => { priority => '0.1' },
	      Operon      => { priority => '0.1' },
	      Paper       => { priority => '0.5' },
	      PCR_product => { priority => '0.1' },
	      Person      => { priority => '0.3' },
#	      Person_name => { priority => '0.3' },
	      Phenotype   => { priority => '0.5' },
#	      Protein     => {
...
unlink("url_lists/current_urls.txt");
