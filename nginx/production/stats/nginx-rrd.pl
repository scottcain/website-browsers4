...
# Add a cron job to be run every minute.
# * * * * *   root    /usr/local/wormbase/website-admin/nginx/production/stats/rrd_nginx.pl


# define location of rrdtool databases
my $rrd = '/usr/local/wormbase/website-admin/nginx/production/stats/nginx';
# define location of images
my $img = '/usr/local/wormbase/website-admin/nginx/production/stats/nginx/img';
# define your nginx stats URL
my $URL = "http://www.wormbase.org/stats/nginx/raw";
