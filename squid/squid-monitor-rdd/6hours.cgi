...
<RRD::GRAPH svctime.6hours.png --title="Service Time -- 6hours"
        --start -6hour
	--upper-limit 0.5
        --imgformat PNG
...
<RRD::GRAPH connections.6hours.png --title="Connections -- 6hours"
        --start -6hour
        --imgformat PNG
...
<RRD::GRAPH objects.6hours.png --title="Cached Objects -- 6hours"
        --start -6hour
        --imgformat PNG
...
<RRD::GRAPH fd.6hours.png --title="File Descriptors -- 6hours"
        --start -6hour
        --imgformat PNG
        --vertical-label "count"
        --width 300 --height 150
...
<RRD::GRAPH hitratio.6hours.png --title="Hit Ratio -- 6hours"
        --start -6hour
        --imgformat PNG
...
<RRD::GRAPH cpu.6hours.png --title="CPU Usage -- 6hours"
        --start -6hour
        --imgformat PNG
        --vertical-label "Percent"
        --width 300 --height 150
...
<!--
RRD::GRAPH memory.6hours.png --title="Memory -- 6hours"
        --start -6hour
        --imgformat PNG
...
-->
<!--
RRD::GRAPH select.6hours.png --title="Select Stats -- 6hours"
        --start -6hour
        --imgformat PNG
        --vertical-label "rate"
        --width 300 --height 150
