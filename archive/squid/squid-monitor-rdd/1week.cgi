...
<RRD::GRAPH svctime.week.png --title="Service Time -- 1week"
        --start -1week
	--upper-limit 0.5
        --imgformat PNG
...
<RRD::GRAPH connections.week.png --title="Connections -- 1week"
        --start -1week
        --imgformat PNG
...
<RRD::GRAPH objects.week.png --title="Cached Objects -- 1week"
        --start -1week
        --imgformat PNG
...
<RRD::GRAPH fd.week.png --title="File Descriptors -- 1week"
        --start -1week
        --imgformat PNG
        --vertical-label "count"
        --width 300 --height 150
...
<RRD::GRAPH hitratio.week.png --title="Hit Ratio -- 1week"
        --start -1week
        --imgformat PNG
...
<RRD::GRAPH cpu.week.png --title="CPU Usage -- 1week"
        --start -1week
        --imgformat PNG
        --vertical-label "Percent"
        --width 300 --height 150
...
<!--
RRD::GRAPH memory.week.png --title="Memory -- 1week"
        --start -1week
        --imgformat PNG
...
RRD::GRAPH select.week.png --title="Select Stats -- 1week"
        --start -1week
        --imgformat PNG
        --vertical-label "rate"
        --width 300 --height 150
