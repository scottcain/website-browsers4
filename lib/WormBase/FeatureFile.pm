package WormBase::FeatureFile;


# This is a small derivation of Lincoln's Bio::Graphics::FeatureFile.
# It's modified to support dynamic generation of GBrowse configuration
# from WormBase GFF3 files.
