...
/* How many seconds to wait for the DNS server to reply before giving up. This
   is only used on some platforms. */
#endif
...
/* Default language for the output page:
   ARMENIAN, BULGARIAN, BULGARIAN_MIK, CATALAN, TRAD_CHINESE (Big5), CZECH,
   CZECH_1250, DANISH, DUTCH, ENGLISH, US_ENGLISH, FINNISH, FRENCH, GERMAN,
   ...
   *
   ...
   BOSNIAN, SIMP_CHINESE (GB2312), CROATIAN, GREEK, ICELANDIC, LITHUANIAN,
   ROMANIAN and SLOVAK. */
#endif
